...
| `MONTI_APM_*` | Various | Galaxy Pro apps with Monti APM enabled have several environment variables starting with `MONTI_APM_` to configure their APM agent. |
